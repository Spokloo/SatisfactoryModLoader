...
int32 AFGCentralStorageSubsystem::GetNumItemsFromCentralStorage(TSubclassOf<class UFGItemDescriptor> itemClass) const{ return int32(); }
void AFGCentralStorageSubsystem::GetAllItemsFromCentralStorage(TArray<FItemAmount>& out_allItems) const{ }
...
bool AFGCentralStorageSubsystem::UploadItemFromInventoryToCentralStorage(class UFGInventoryComponent* inventoryComponent, int32 slotIndexToRemoveFrom){ return bool(); }
bool AFGCentralStorageSubsystem::CanUploadInventoryItemToCentralStorage(const FInventoryItem& inventoryItem) const{ return bool(); }
