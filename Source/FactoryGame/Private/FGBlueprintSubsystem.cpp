...
void UFGBlueprintRemoteCallObject::Server_RequestFileData_Implementation(const FString& fileName){ }
...
AFGBlueprintSubsystem::AFGBlueprintSubsystem() : Super() {
	...
	this->mBlacklistedBlueprintCollectClasses.Add(AFGBuildableSubsystem::StaticClass());
	this->mBlacklistedBlueprintCollectClasses.Add(AFGConveyorChainActor::StaticClass());
	this->mBlacklistedBlueprintCollectClasses.Add(AFGBuildableBlueprintDesigner::StaticClass());
	this->mBlacklistedBlueprintCollectClasses.Add(AFGSubsystem::StaticClass());
	this->mBlacklistedBlueprintCollectClasses.Add(AFGWorldSettings::StaticClass());
	this->mBlacklistedBlueprintCollectClasses.Add(AFGBlueprintProxy::StaticClass());
	this->mBlacklistedBlueprintCollectClasses.Add(AFGPlayerController::StaticClass());
	this->mBlacklistedBlueprintCollectClasses.Add(AFGCharacterBase::StaticClass());
	this->mBlacklistedBlueprintCollectClasses.Add(AFGTrainStationIdentifier::StaticClass());
	this->mBlacklistedBlueprintCollectClasses.Add(AFGDroneStationInfo::StaticClass());
...
UFGBlueprintDescriptor* AFGBlueprintSubsystem::GetBlueprintDescriptorByNameString(const FString& blueprintName){ return nullptr; }
